...
namespace Cliente
{
    public partial class Form1 : Form
    {
        ...
        string usuario_eliminado;
        string psw_eliminado;
        int conectado = 0;
        ...
        delegate void DelegadoParaTurno(string mensaje);
        delegate void DelegadoParaOcultar();
        delegate void DelegadoParaDado();
        delegate void DelegadoParaConectar();
        delegate void DelegadoParaDesconectar();
        delegate void DelegadoParaEliminarCuenta();
        delegate void DelegadoParaEmpezar();
        ...
        public Form1()
        {
            ...
            Dado_But.Visible = false;
            valor_dado.Visible = false;
            turno_lbl.Visible = false;
            TurnoBox.Visible = false;
            Normas_btn.Visible = false;
            Invitado_group.Visible = false;
            Invitacion_group.Visible = false;
            Conectados_box.Visible = false;
            listBox1.Visible = false;
            Chat_box.Visible = false;
            Enviar_chat.Visible = false;
            Jugador_lbl.Visible = false;
            usu_eliminar_box.Visible = false;
            psw_eliminar_box.Visible = false;
            usu_eliminar_lbl.Visible = false;
            psw_eliminar_lbl.Visible = false;
            Eliminarcuenta_btn.Visible = false;
            Enviar_cuenta_btn.Visible = false;
            Termin_rojo_lbl.Visible = false;
            Termin_am_lbl.Visible = false;
            num_am_term_lbl.Visible = false;
            num_rojo_term_lbl.Visible = false;
        ...
        {
            this.invitado_lbl.Text = mensaje + " te ha invitado";
        }  //función para modificar la invitacion 
        ...
        private void Turno_box_del(string mensaje)
        {
            this.TurnoBox.Text= mensaje;
        }  //funcion para modificar el turno entre clientes

        private void Jugador(string mensaje)
        {
            this.Jugador_lbl.Text = mensaje;
        }  //funcion para indicar el jugador actual entre clientes

        private void Esconder_invitacion()
        {
            this.Invitado_group.Visible = false;
            this.Invitacion_group.Visible = false;
            this.Empezar_btn.Enabled = false;
        }   //funcion para esconder los bloques de invitacion

        private void Permiso_dado_bloqueado()
        {
            this.Dado_But.Enabled = false;
            this.dado_pb.Enabled = false;
        }  //funcion para bloquear el dado

        private void Permiso_dado()
        {
            this.Dado_But.Enabled = true;
            this.dado_pb.Enabled = true;
        }  //funcion para desbloquear el dado
        ...
        private void Conectar()
        {
            ...
            Enviar_chat.Visible = true;
            Empezar_btn.Visible = true;
            ...
            valor_dado.Visible = true;
            turno_lbl.Visible = true;
            TurnoBox.Visible = true;
            Normas_btn.Visible = true;
            ...
            Jugador_lbl.Visible = true;
            usu_eliminar_box.Visible = false;
            psw_eliminar_box.Visible = false;
            usu_eliminar_lbl.Visible = false;
            psw_eliminar_lbl.Visible = false;
            Enviar_cuenta_btn.Visible = false;
            Eliminarcuenta_btn.Visible = true;
            Termin_rojo_lbl.Visible = true;
            Termin_am_lbl.Visible = true;
            num_am_term_lbl.Visible = true;
            num_rojo_term_lbl.Visible = true;

        }  //funcion para realizar la conexión y mostrar el tablero
        ...
        {
            Eliminarcuenta_btn.Enabled = true;
            usu_eliminar_box.Visible = false;
            psw_eliminar_box.Visible = false;
            usu_eliminar_lbl.Visible = false;
            psw_eliminar_lbl.Visible = false;
        ...
        {
            this.Empezar_btn.Enabled = true;
        }  //funcion para permitir empezar partida

        private void Terminar_Rojo(string mensaje)
        {
            this.num_rojo_term_lbl.Text = mensaje;
        }  //funcion para contar las fichas terminadas entre clientes

        private void Terminar_Amarillo(string mensaje) //funcion para contar las fichas terminadas entre clientes
        {
            this.num_am_term_lbl.Text = mensaje;
        }
                ...
                while (true)
                {
                    ...
                    switch (codigo)
                    {
                           ...
                           if(usuario == mensaje)
                            {
                                ...
                                Iniciar_Session.Invoke(new DelegadoParaConectar(Conectar));
                            }
                            try
                            {
                                int z = Convert.ToInt32(mensaje);
                                if ((z == 1) || (z == 0))
                                {

                                    MessageBox.Show("Alguno de los datos es incorrecto");
                                    Desconectarse_Del_Servidor.Invoke(new DelegadoParaDesconectar(Desconectar));

                                }
                            }
                            catch (SyntaxErrorException)
                            {
                                MessageBox.Show("Ha ocurrido un error, vuelve a intentarlo más tarde");
                            }
                            break;
                        ...
                        case 6:   //Invitar a un jugador
                            ...
                            jugador_invitador = mensaje;
                            mensaje = trozo[2].Split('\0')[0];
                            jugador_invitado = mensaje;
                        ...
                        case 7:  // Respuesta a la invitacion
                            ...
                            else
                            {
                                ...
                                Empezar_btn.Invoke(new DelegadoParaEmpezar(Empezar_partida));
                        ...
                        case 9:  //Registro
                            if (usuario == mensaje)
                            {
                                ...
                                Registrarse.Invoke(new DelegadoParaConectar(Conectar));
                            }
                        ...
                        case 10:  //Movimientos del tablero entre distintos clientes
                            pb = Convert.ToInt32(trozo[1].Split('\0')[0]);
                            posx_serv = Convert.ToInt32(trozo[2].Split('\0')[0]);
                            posy_serv = Convert.ToInt32(trozo[3].Split('\0')[0]);
                            switch (pb)
                            {
                                case 0: //Creamos un caso para cada picturebox (Basado en las posiciones en la matriz de fichas)
                                    roja_1.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 1:
                                    roja_2.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 2:
                                    roja_3.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 3:
                                    roja_4.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 4:
                                    verde_1.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 5:
                                    verde_2.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 6:
                                    verde_3.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 7:
                                    verde_4.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 8:
                                    azul_1.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 9:
                                    azul_2.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 10:
                                    azul_3.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 11:
                                    azul_4.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 12:
                                    amarilla_1.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 13:
                                    amarilla_2.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 14:
                                    amarilla_3.Location = new Point(posx_serv, posy_serv);
                                break;

                                case 15:
                                    amarilla_4.Location = new Point(posx_serv, posy_serv);
                                break;
                        ...
                        case 12:
                            MessageBox.Show("La partida va a iniciar, empieza: " + mensaje);
                            Jugador_lbl.Invoke(new DelegadoParaTurno(Jugador), new object[] { mensaje });
                            Invitacion_group.Invoke(new DelegadoParaOcultar(Esconder_invitacion));                         
                            mensaje = trozo[2].Split('\0')[0];
                            TurnoBox.Invoke(new DelegadoParaTurno(Turno_box_del), new object[] { mensaje });
                            Dado_But.Invoke(new DelegadoParaDado(Permiso_dado_bloqueado));
                            break;
                        ...
                        case 13:
                            ...
                            habilitar_fichas(mensaje);
                            TurnoBox.Invoke(new DelegadoParaTurno(Turno_box_del), new object[] { mensaje });
                            mensaje = trozo[2].Split('\0')[0];
                            jugador_actual = mensaje;
                            Jugador_lbl.Invoke(new DelegadoParaTurno(Jugador), new object[] { mensaje });
                            Dado_But.Invoke(new DelegadoParaDado(Permiso_dado));
                            break;
                        ...
                        case 15:
                            ...
                            {
                                MessageBox.Show("Se ha eliminado correctamente el usuario " + mensaje);
                                Desconectarse_Del_Servidor.Invoke(new DelegadoParaDesconectar(Desconectar));
                            }
                            else
                            {
                                try
                                {
                                    int r = Convert.ToInt32(mensaje);
                                    if (r == 0)
                                    {
                                        MessageBox.Show("Ha ocurrido un error consultando la base de datos, vuelve a intentarlo");
                                        Eliminarcuenta_btn.Invoke(new DelegadoParaEliminarCuenta(Eliminar_cuenta));
                                    }
                                    ...
                                    if (r==-1)
                                    {
                                        MessageBox.Show("El usuario no existe, introduzca de nuevo los datos");
                                        Eliminarcuenta_btn.Invoke(new DelegadoParaEliminarCuenta(Eliminar_cuenta));
                                    }
                                }
                                catch (SyntaxErrorException)
                                {
                                    MessageBox.Show("Ha ocurrido un error al procesar su solicitud, vuelve a intentarlo más tarde");
                                }
                            }
                            break;
                        ...
                        case 16:
                            ...
                            {
                                mensaje = trozo[2].Split('\0')[0];
                                terminadosrojo = Convert.ToInt32(mensaje);
                                num_rojo_term_lbl.Invoke(new DelegadoParaEscribir(Terminar_Rojo), new object[] { mensaje });
                            ...
                            {
                                mensaje = trozo[2].Split('\0')[0];
                                terminadosamarillo = Convert.ToInt32(mensaje);
                                num_am_term_lbl.Invoke(new DelegadoParaEscribir(Terminar_Amarillo), new object[] { mensaje });
                                if (terminadosamarillo >= 4)   //Cuando han entrado las 4 fichas se considera ganada la partida.
                                {
        ...
        }  //funcion para atender al servidor
        ...
        {
            if ((Usuario1Box.Text != string.Empty) && (Contra1Box.Text != string.Empty) && (conectado == 0))
            {
                usuario = Usuario1Box.Text;
                int Puerto1 = 50079;
                //int Puerto3 = 50080;
                //int Puerto2 = 50081;
        ...
        {
            string mensaje = "6/" + usuario + "/" + invitar_box.Text;
        ...
        private void Rechazar_btn_Click(object sender, EventArgs e)
        {
            ...
            server.Send(msg);
            Empezar_btn.Enabled = false;
            invitado_lbl.Text = "No te han invitado aún";
        }   // boton para rechazar una invitacion
        ...
        }   //boton para aceptar una invitacion
        ...
        }   //funcion para habilitar el uso de las fichas
        ...
        }//funcion para deshabilitar el uso de las fichas
        ...
        private void PasarTurno()
        {
            ...
            string mensaje_turno = "11/" + turno + "/" + jugador_actual; //enviamos al servidor el color que debe tirar y quien ha realizado el movimiento
            byte[] msg_turno = System.Text.Encoding.ASCII.GetBytes(mensaje_turno);
            server.Send(msg_turno);
            if (jugador_actual == jugador_invitado)
                jugador_actual = jugador_invitador;
            else
                jugador_actual = jugador_invitado;
        ...
        }  //Funcion que se ejecuta al inciar el form
        ...
        private void roja_1_Click(object sender, EventArgs e)
        {
            if (fichas[0].Casa && dado == 5)
            {
                ...
                dado_pb.Enabled = true;    //Volvemos  activar el dado para realizar otra tirada
                string mensaje = "9/0/" + rojo1.Pos_x + "/" + rojo1.Pos_y + "/" + jugador_actual;  //Mandamos al servidor la ficha, su posicion y el jugador
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
            ...
            {
                deshabilitar_fichas("todas");
                string mensaje = "9/0/" + rojo1.Pos_x + "/" + rojo1.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
                PasarTurno();
            ...
            else
            {
                for (int i = dado; i > 0; i--)  //Si no esta en casa entonces se mueve según el valor del dado
                {
                    ...
                    while (comedora)  //en el caso de que al comer una haya comido otra, repite el proceso
                    {
            ...
            if (fichas[0].Terminado)   //Si llega al final
            {
                //roja_1.Visible = false;
                terminadosrojo++;
                num_rojo_term_lbl.Text = Convert.ToString(terminadosrojo);
                Thread.Sleep(300);
                string mensaje_terminado = "13/rojo/"+ jugador_actual+"/"+terminadosrojo;  //Mandamos el color de la ficha que ha terminado, el jugador y cuantas han terminado ya
                byte[] msg_term = System.Text.Encoding.ASCII.GetBytes(mensaje_terminado);
                server.Send(msg_term);
                if (terminadosrojo >= 4)   //Cuando han entrado las 4 fichas se considera ganada la partida.
                {
                    MessageBox.Show("Ha ganado el equipo rojo");
                    Application.Exit();
        ...
        }  //funcion para cuando se pulsa una ficha
        ...
        private void roja_2_Click(object sender, EventArgs e)
        {
            if (fichas[1].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/1/" + rojo2.Pos_x + "/" + rojo2.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
            ...
            if (fichas[1].Terminado)
            {
                ...
                num_rojo_term_lbl.Text = Convert.ToString(terminadosrojo);
                Thread.Sleep(300);
                string mensaje_terminado = "13/rojo/" + jugador_actual + "/" + terminadosrojo;
                byte[] msg_term = System.Text.Encoding.ASCII.GetBytes(mensaje_terminado);
                server.Send(msg_term);
                if (terminadosrojo >= 4)
                {
        ...
        private void roja_3_Click(object sender, EventArgs e)
        {
            if (fichas[2].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/2/" + rojo3.Pos_x + "/" + rojo3.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void roja_4_Click(object sender, EventArgs e)
        {
            if (fichas[3].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/3/" + rojo4.Pos_x + "/" + rojo4.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void verde_1_Click(object sender, EventArgs e)
        {
            if (fichas[4].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/4/" + verde1.Pos_x + "/" + verde1.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void verde_2_Click(object sender, EventArgs e)
        {
            if (fichas[5].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/5/" + verde2.Pos_x + "/" + verde2.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
            }
        ...
        private void verde_3_Click(object sender, EventArgs e)
        {
            if (fichas[6].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/6/" + verde3.Pos_x + "/" + verde3.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void verde_4_Click(object sender, EventArgs e)
        {
            if (fichas[7].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/7/" + verde4.Pos_x + "/" + verde4.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void azul_1_Click(object sender, EventArgs e)
        {
            if (fichas[8].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/8/" + azul1.Pos_x + "/" + azul1.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void azul_2_Click(object sender, EventArgs e)
        {
            if (fichas[9].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/9/" + azul2.Pos_x + "/" + azul2.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void azul_3_Click(object sender, EventArgs e)
        {
            if (fichas[10].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/10/" + azul3.Pos_x + "/" + azul3.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void azul_4_Click(object sender, EventArgs e)
        {
            if (fichas[11].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/11/" + azul4.Pos_x + "/" + azul4.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void amarilla_1_Click(object sender, EventArgs e)
        {
            if (fichas[12].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/12/" + amarillo1.Pos_x + "/" + amarillo1.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
            ...
            if (fichas[12].Terminado)
            {
                //amarilla_1.Visible = false;
                terminadosamarillo++;
                num_am_term_lbl.Text = Convert.ToString(terminadosamarillo);
                Thread.Sleep(300);
                string mensaje_terminado = "13/amarillo/" + jugador_actual + "/" + terminadosamarillo;
                byte[] msg_term = System.Text.Encoding.ASCII.GetBytes(mensaje_terminado);
                server.Send(msg_term);
        ...
        private void amarilla_2_Click(object sender, EventArgs e)
        {
            if (fichas[13].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/13/" + amarillo2.Pos_x + "/" + amarillo2.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void amarilla_3_Click(object sender, EventArgs e)
        {
            if (fichas[14].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/14/" + amarillo3.Pos_x + "/" + amarillo3.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void amarilla_4_Click(object sender, EventArgs e)
        {
            if (fichas[15].Casa && dado == 5)
            {
                ...
                deshabilitar_fichas("todas");
                dado_pb.Enabled = true;
                string mensaje = "9/15/" + amarillo4.Pos_x + "/" + amarillo4.Pos_y + "/" + jugador_actual;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
        ...
        private void Empezar_btn_Click(object sender, EventArgs e)  //funcion para iniciar el juego
        {  
            Boolean error = true;
            while (error)
            {
                //sale un popup preguntando que color va a empezar;
                turno = Interaction.InputBox("¿Que color va a empezar, amarillo o rojo?", "Color", "ROJO");
            ...
            jugador_actual = jugador_invitador;
            Jugador_lbl.Text = jugador_actual;
            string mensaje = "10/"+jugador_actual+"/"+turno;  //Mandamos al servidor el jugador que empieza y su color
            byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
            server.Send(msg);
            Invitado_group.Visible = false;
            Invitacion_group.Visible = false;
            Empezar_btn.Enabled = false;
            Dado_But.Enabled = true;
            dado_pb.Enabled = true;
        ...
        private void Enviar_chat_Click(object sender, EventArgs e)
        {
            try
            {
                if (Chat_box.Text != null)
                {
                    string mensaje = "8/" + Chat_box.Text;
                    byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                    server.Send(msg);
                    Chat_box.Clear();
                }
        ...
        } //funcion para enviar mensajes por el chat

        private void Eliminarcuenta_btn_Click(object sender, EventArgs e)
        {
            usu_eliminar_box.Visible = true;
            psw_eliminar_box.Visible = true;
            usu_eliminar_lbl.Visible = true;
            psw_eliminar_lbl.Visible = true;
            Enviar_cuenta_btn.Visible = true;
            Eliminarcuenta_btn.Enabled = false;           
        }  // funcion para poder eliminar cuenta


        private void Enviar_cuenta_btn_Click(object sender, EventArgs e)
        {
            if ((usu_eliminar_box.Text != string.Empty) && (psw_eliminar_box.Text != string.Empty) && (conectado == 1))
            {
                usuario_eliminado = usu_eliminar_box.Text;
                psw_eliminado = psw_eliminar_box.Text;

                string mensaje = "12/" + usuario_eliminado + "/" + psw_eliminado;
                byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
                server.Send(msg);
            }
            else
                MessageBox.Show("Rellena todos los campos");
        } //funcion que envia los datos para eliminar una cuenta
        ...
        private void Normas_btn_Click(object sender, EventArgs e)
        {
            Process proceso = new Process();
            proceso.StartInfo.FileName = @"C:\Share\Parchis_G10\normativa.pdf";
            proceso.Start();
        }
